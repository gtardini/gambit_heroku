  ...
  if hour - picked_hour >= 0
  	if home_win_odds < away_win_odds
	  	...
	  	if home_win_odds%0.05!=0
  		   ...
  		   "#{number_of_black_swans} black swan(s)."  
	  	...
	  	if perc[0] != nil
  		  ...
  		  "tabella accuracy percentage not computed."  
...
p matches_data[match_name][4]= away_team
p matches_data[match_name][5]= away_win_odds
p matches_data[match_name][6]= mixed_percentage
p matches_data[match_name][7]= chance
p matches_data[match_name][8]= odds_weighted_chance
p matches_data[match_name][9]= chance_weighted_convenience
p matches_data[match_name][10]= roo_home_perc
p matches_data[match_name][11]= roo_away_perc
p matches_data[match_name][12]= perc[0][0]
p matches_data[match_name][13]= number_of_black_swans
